...
//   }).addTo(myMap);
  ...
  if (cities[i].totaldeaths > 150) {
    ...
    }).bindPopup("<h1>" + cities[i].name + "<h1> <hr> <h2> Total Cases: " + cities[i].totalcases + "</h2> <hr> <h3> Total Deaths: " + cities[i].totaldeaths + 
    "</h3> <hr> <h4> Date: " + cities[i].date + "</h4>"  ).addTo(myMap);
  }
